      ...
      <div className="relative overflow-x-auto">
        <div className="flex gap-4 w-max">
          ...
          <div className="flex flex-col">
            <button
              className={`relative w-[520px] h-[520px] rounded-xl overflow-hidden cursor-zoom-in group
          ...
          <div className="flex flex-col gap-4">
            {supportImages.slice(0, 3).map((img) => (
              <button
                key={img.src}
                className={`relative w-[260px] h-[160px] rounded-xl overflow-hidden cursor-zoom-in group
