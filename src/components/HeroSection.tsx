...
export default function HeroSection({ slides }: HeroSectionProps) {
  return (
    <section
      id="inicio"
      className="w-full bg-gradient-to-br from-indigo-950 to-purple-900 relative pb-16 pt-24"
    >
      {" "}
      ...
      <div className="w-full flex flex-col justify-center items-center py-8 px-2.5 sm:px-4">
        <div className="w-full sm:w-[90%] max-w-[1920px] mb-10 text-center px-2.5 sm:px-0">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">
            <span
              className={`bg-clip-text text-transparent bg-gradient-to-r from-amber-300 to-pink-300 ${hennyPenny.className}`}
            >
              Mansão dos Sonhos
            </span>
          </h1>
